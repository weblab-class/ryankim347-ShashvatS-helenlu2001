...
class Leaderboard extends Component {
  ...
  componentDidMount() {
    ...
    this.setState({leaderboardInfo: this.props.location.state.leaderboardInfo.sort((a, b) => (a.points > b.points) ? -1 : 1)});
  }
    ...
    for(let i = 3; i < this.state.leaderboardInfo.length; i++) {
      rest.push(
        <div className='Leaderboard-restrow'>
          ...
          <div className='Leaderboard-restname' style={{color: this.state.leaderboardInfo[i].color}}> {this.state.leaderboardInfo[i].name} </div>
      ...
      <>
        ...
        <div className='Leaderboard-container'>
          ...
          <div className='Leaderboard-top3container'>
            ...
            <div className='Leaderboard-name'> {this.state.leaderboardInfo[1] ? this.state.leaderboardInfo[1].name.toUpperCase(): ''} </div>
              <div className='Leaderboard-second Leaderboard-top3'> 2ND </div>
            </div>
            <div className='Leaderboard-place'>
            <div className='Leaderboard-name'> {this.state.leaderboardInfo[0] ? this.state.leaderboardInfo[0].name.toUpperCase(): ''} </div>
              <div className='Leaderboard-first Leaderboard-top3'> 1ST </div>
            </div>
            <div className='Leaderboard-place'>
              <div className='Leaderboard-name'> {this.state.leaderboardInfo[2] ? this.state.leaderboardInfo[2].name.toUpperCase(): ''} </div>
